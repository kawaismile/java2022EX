...
public class GetType2 {
            ...
            public static String getImgType(byte[] src){
                String xxx = bytesToHexString(src);
                xxx = xxx.substring(0, 6).toUpperCase();
        ...
        class TypeDict {
            ...
            public static String checkType(String xxxx) {
                ...
                if ("89504E".equals(xxxx)) {
                    return "png";
                }
                if ("474946".equals(xxxx)) {
                    return "gif";
                }
                return "Unknown";
            }
